// Video scrolling effect - scrubs video based on scroll position
function initVideoScroll() {
    ...
    if (!scrollVideo || !scrollSection || !scrollSpacer) return;
    ...
    scrollVideo.addEventListener('loadedmetadata', function() {
        function updateVideo() {
            ...
            const videoTime = progress * scrollVideo.duration;
